...
namespace FinancasApp.Presentation.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        /// <summary>
        /// Método para retornar o total de contas a pagar e receber
        /// </summary>
        ...
        {
            return movimentacoes.GroupBy(g => g.Categoria?.Nome)
                        .Select(g => new ChartViewModel { Name = g.Key, Data = g.Sum(m => m.Valor) }).ToList();
        }
    }
}
